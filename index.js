		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: 'ESTE PEDIDO É ESPECÍFICO PARA O MODERADOR DO ⚡SUPER Victor⚡*',
					...
					Badmin: 'Este comando so pode ser usado quando o ⚡SUPER Victor⚡ se torna ADM do grupo parsa',
				}
			}
